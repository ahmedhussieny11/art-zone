...
export const metadata: Metadata = {
  title: "تواصل معنا",
  description: "تواصل مع آرت زون للتصميم لمشروع التصميم الداخلي الفاخر الخاص بك. احجز استشارة مجانية اليوم.",
};
    ...
    <>
      <section className="bg-charcoal pb-16 pt-32 md:pt-40">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <SectionHeading
            label="تواصل معنا"
            title={s.contactPageTitle || "اتصل بنا"}
            description={s.contactPageSubtitle || "يسعدنا سماع تفاصيل مشروعك. تواصل معنا ولنبتكر شيئاً استثنائياً معاً."}
            ...
            <FadeIn className="lg:col-span-3">
              <div className="bg-white p-8 md:p-12">
                <h3 className="mb-2 font-serif text-2xl font-light text-charcoal">
                  {s.contactFormTitle || "طلب استشارة"}
                </h3>
                <p className="mb-8 text-sm text-warmgray">
                  {s.contactFormSubtitle || "املأ النموذج أدناه وسيتواصل فريقنا معك خلال 24 ساعة."}
                </p>
                <ContactForm
            ...
            <FadeIn delay={0.2} className="lg:col-span-2">
              <div className="space-y-10">
                <div>
                  ...
                  <a href={waUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 text-lg text-charcoal transition-colors hover:text-gold">
      ...
      {s.googleMapsEnabled !== false && (
        <section className="bg-white">
          <div className="aspect-[21/9] w-full bg-warmgray/10">
            {s.googleMapsUrl ? (
              <iframe
                src={s.googleMapsUrl}
              ...
              <div className="flex h-full w-full items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="mt-3 text-sm text-warmgray">أضف رابط خريطة جوجل من الإعدادات</p>
                </div>
              </div>
            )}
          </div>
