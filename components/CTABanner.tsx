    ...
    <section className="relative overflow-hidden bg-offwhite py-24 md:py-32">
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center lg:px-12">
        <FadeIn>
          ...
          <p className="mx-auto mt-6 max-w-lg text-lg leading-relaxed text-warmgray">
            {bannerDesc}
          </p>
          <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 border border-charcoal/15 px-10 py-4 text-sm font-medium tracking-widest text-charcoal transition-all hover:border-gold hover:text-gold"
            >
